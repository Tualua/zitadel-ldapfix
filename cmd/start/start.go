...
import (
	...
	cmd_tls "github.com/Tualua/zitadel-ldapfix/cmd/tls"
	...
	"github.com/Tualua/zitadel-ldapfix/internal/api"
	"github.com/Tualua/zitadel-ldapfix/internal/api/assets"
	internal_authz "github.com/Tualua/zitadel-ldapfix/internal/api/authz"
	action_v2 "github.com/Tualua/zitadel-ldapfix/internal/api/grpc/action/v2"
	action_v2_beta "github.com/Tualua/zitadel-ldapfix/internal/api/grpc/action/v2beta"
	"github.com/Tualua/zitadel-ldapfix/internal/api/grpc/admin"
	app "github.com/Tualua/zitadel-ldapfix/internal/api/grpc/app/v2beta"
	"github.com/Tualua/zitadel-ldapfix/internal/api/grpc/auth"
	authorization_v2beta "github.com/Tualua/zitadel-ldapfix/internal/api/grpc/authorization/v2beta"
	feature_v2 "github.com/Tualua/zitadel-ldapfix/internal/api/grpc/feature/v2"
	feature_v2beta "github.com/Tualua/zitadel-ldapfix/internal/api/grpc/feature/v2beta"
	idp_v2 "github.com/Tualua/zitadel-ldapfix/internal/api/grpc/idp/v2"
	instance "github.com/Tualua/zitadel-ldapfix/internal/api/grpc/instance/v2beta"
	internal_permission_v2beta "github.com/Tualua/zitadel-ldapfix/internal/api/grpc/internal_permission/v2beta"
	"github.com/Tualua/zitadel-ldapfix/internal/api/grpc/management"
	oidc_v2 "github.com/Tualua/zitadel-ldapfix/internal/api/grpc/oidc/v2"
	oidc_v2beta "github.com/Tualua/zitadel-ldapfix/internal/api/grpc/oidc/v2beta"
	org_v2 "github.com/Tualua/zitadel-ldapfix/internal/api/grpc/org/v2"
	org_v2beta "github.com/Tualua/zitadel-ldapfix/internal/api/grpc/org/v2beta"
	project_v2beta "github.com/Tualua/zitadel-ldapfix/internal/api/grpc/project/v2beta"
	"github.com/Tualua/zitadel-ldapfix/internal/api/grpc/resources/debug_events/debug_events"
	user_v3_alpha "github.com/Tualua/zitadel-ldapfix/internal/api/grpc/resources/user/v3alpha"
	userschema_v3_alpha "github.com/Tualua/zitadel-ldapfix/internal/api/grpc/resources/userschema/v3alpha"
	saml_v2 "github.com/Tualua/zitadel-ldapfix/internal/api/grpc/saml/v2"
	session_v2 "github.com/Tualua/zitadel-ldapfix/internal/api/grpc/session/v2"
	session_v2beta "github.com/Tualua/zitadel-ldapfix/internal/api/grpc/session/v2beta"
	settings_v2 "github.com/Tualua/zitadel-ldapfix/internal/api/grpc/settings/v2"
	settings_v2beta "github.com/Tualua/zitadel-ldapfix/internal/api/grpc/settings/v2beta"
	"github.com/Tualua/zitadel-ldapfix/internal/api/grpc/system"
	user_v2 "github.com/Tualua/zitadel-ldapfix/internal/api/grpc/user/v2"
	user_v2beta "github.com/Tualua/zitadel-ldapfix/internal/api/grpc/user/v2beta"
	webkey_v2 "github.com/Tualua/zitadel-ldapfix/internal/api/grpc/webkey/v2"
	webkey_v2beta "github.com/Tualua/zitadel-ldapfix/internal/api/grpc/webkey/v2beta"
	...
	"github.com/Tualua/zitadel-ldapfix/internal/api/idp"
	"github.com/Tualua/zitadel-ldapfix/internal/api/oidc"
	"github.com/Tualua/zitadel-ldapfix/internal/api/robots_txt"
	"github.com/Tualua/zitadel-ldapfix/internal/api/saml"
	"github.com/Tualua/zitadel-ldapfix/internal/api/scim"
	"github.com/Tualua/zitadel-ldapfix/internal/api/scim/schemas"
	"github.com/Tualua/zitadel-ldapfix/internal/api/ui/console"
	"github.com/Tualua/zitadel-ldapfix/internal/api/ui/console/path"
	...
	"github.com/Tualua/zitadel-ldapfix/internal/authz"
	authz_repo "github.com/Tualua/zitadel-ldapfix/internal/authz/repository"
	...
	cryptoDB "github.com/Tualua/zitadel-ldapfix/internal/crypto/database"
	...
	"github.com/Tualua/zitadel-ldapfix/internal/logstore/emitters/access"
	emit_execution "github.com/Tualua/zitadel-ldapfix/internal/logstore/emitters/execution"
	emit_stdout "github.com/Tualua/zitadel-ldapfix/internal/logstore/emitters/stdout"
	"github.com/Tualua/zitadel-ldapfix/internal/logstore/record"
	"github.com/Tualua/zitadel-ldapfix/internal/net"
	"github.com/Tualua/zitadel-ldapfix/internal/notification"
	...
	es_v4 "github.com/Tualua/zitadel-ldapfix/internal/v2/eventstore"
	es_v4_pg "github.com/Tualua/zitadel-ldapfix/internal/v2/eventstore/postgres"
	"github.com/Tualua/zitadel-ldapfix/internal/webauthn"
	"github.com/Tualua/zitadel-ldapfix/openapi"
)
