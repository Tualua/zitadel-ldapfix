...
Check out all [Zitadel Release Versions](https://github.com/Tualua/zitadel-ldapfix/releases)

### v2.x

**Current State**: General Availability / Stable

**Release**: [v2.x](https://github.com/Tualua/zitadel-ldapfix/releases?q=v2.&expanded=true)
...
**Release**: [v3.x](https://github.com/Tualua/zitadel-ldapfix/releases?q=v3.&expanded=true)
...
<details>
    ...
    <details>
        ...
        More details can be found [here](https://github.com/Tualua/zitadel-ldapfix/issues/9414)
    </details>
...
<details>
    ...
    <details>
        ...
        For more details read the [Github Issue](https://github.com/Tualua/zitadel-ldapfix/issues/6305)
    </details>
...
<details>
    ...
    <details>
        ...
        <details>
            ...
            For more details track our [github issue](https://github.com/Tualua/zitadel-ldapfix/issues/7506).
        </details>
        ...
        <details>
            ...
            For more details track our [github issue](https://github.com/Tualua/zitadel-ldapfix/issues/9709).
        </details>
        ...
        <details>
            ...
            For more details track our [github issue](https://github.com/Tualua/zitadel-ldapfix/issues/9476).
    ...
    <details>
        ...
        More details about the feature can be found [here](https://github.com/Tualua/zitadel-ldapfix/issues/9702)
    </details>
    ...
    <details>
        ...
        Stay updated on the progress and details on our [GitHub Issue](https://github.com/Tualua/zitadel-ldapfix/issues/9535)
    </details>
    ...
    <details>
        ...
        For more details check out our [GitHub Issue](https://github.com/Tualua/zitadel-ldapfix/issues/4386)
    </details>
</details>
...
<details>
    ...
    <details>
        ...
        More details can be found in the (GitHub Issue](https://github.com/Tualua/zitadel-ldapfix/issues/9707)
    </details>
    ...
    <details>
        ...
        More details can be found in the (GitHub Issue](https://github.com/Tualua/zitadel-ldapfix/issues/6601)
    </details>
    ...
    <details>
        ...
        <details>
            ...
            For more details track our [GitHub issue](https://github.com/Tualua/zitadel-ldapfix/issues/9711).
        </details>
    </details>
