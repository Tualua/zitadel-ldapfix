...
It is not possible to use files as source or destination. See github issue [here](https://github.com/Tualua/zitadel-ldapfix/issues/7966)

Currently the encryption keys of the source database must be copied to the destination database. See github issue [here](https://github.com/Tualua/zitadel-ldapfix/issues/7964)
