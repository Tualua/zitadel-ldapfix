...
ZITADEL uses a [different configuration file](https://github.com/Tualua/zitadel-ldapfix/blob/main/cmd/setup/steps.yaml) for _database initialization steps_.
...
- Check out all possible [runtime configuration properties and their defaults in the source code](https://github.com/Tualua/zitadel-ldapfix/blob/main/cmd/defaults.yaml)
- Check out all possible [setup step configuration properties and their defaults in the source code](https://github.com/Tualua/zitadel-ldapfix/blob/main/cmd/setup/steps.yaml)
