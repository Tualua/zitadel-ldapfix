...
[feat(login): use default org for login without provided org context](https://github.com/Tualua/zitadel-ldapfix/pull/6625), which was released in Version [2.38.0](https://github.com/Tualua/zitadel-ldapfix/releases/tag/v2.38.0)
